...
def run_ghidra_extract(
    *,
    ...
    # Note: String references extraction (inline strings from decompiled code)
    # is now done dynamically by chat_tools_v2.get_string_references()
    # using the decomp/*.c files generated above. No separate script needed.
